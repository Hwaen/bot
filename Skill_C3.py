...
def skill(msg,skill):
        ...
        if response.status_code == 200:
                ...
                #### Q2 ####
                        ...
                        embed.set_author(name=(str(title_1)+"\t|\t"+str(title_2)+"\t"+level_1+"레벨"), )
                ...
                if skill == "R" or skill == "r":
                        ...
                        title= soup.select_one("#erDb > div:nth-child(4) > div:nth-child(7) > div.skillTitle > span.skillName").get_text()
                        img = soup.select_one("#erDb > div:nth-child(4) > div:nth-child(7) > div.skillTitle > span.skillIcon > img").get("src")
