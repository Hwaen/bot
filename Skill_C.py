...
name = {'재키' : 'Jackie',        '아야' : 'Aya',       '현우' : 'Hyunwoo',
        '매그너스' : 'Magnus',    '피오라' : 'Fiora',   '나딘' : 'Nadine',
        '자히르' : 'Zahir',       '하트' : 'Hart',      '아이솔' : 'Isol',
        '리다이린' : 'Li_Dailin', '유키' : 'Yuki',      '혜진' : 'Hyejin',
        '쇼우' : 'XiuKai',        '시셀라' : 'Sissela', '키아라' : 'Chiara',
