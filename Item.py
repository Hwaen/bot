...
######도끼#####
    ...
    if msg=="손도끼":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로", value="연못(5) 모래사장(6) 공장(5)\n사냥 들개", inline=False)
        return embed
...
#####채찍#####
    if msg=="채찍":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로", value="공장(4) 학교(3)", inline=False)
        return embed
