...
#####장식#####
    ...
    if msg=="호루스의눈":
        embed=discord.Embed(title="호루스의 눈", description="레벨 당 스킬 증폭 +0.75%\n시야 +1.5\n```의념 (고유 장착 효과)\n스킬 증폭의 2.5배(근거리)/1.5배(원거리)의 고유 피해를 입힙니다.\n(쿨다운: 2초)```", color=0x9c4998)
