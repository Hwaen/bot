...
#####망치#####
    if msg=="망치":
        ...
        embed.add_field(name="휙득 경로 ", value="연못(12) 모래사장(12) 골목길(13)\n사냥 멧돼지", inline=False)
        return embed
    ...
    if msg=="운명의망치":
        embed=discord.Embed(title="모닝 스타", description="공격력 +50", color=0x1e82cd)
    ...
    if msg=="낭아봉":
        embed=discord.Embed(title="낭아봉", description=" 공격력 +70\n스킬 증폭 +20%\n", color=0x9c4998)
    ...
    if msg=="다그다의망치":
        embed=discord.Embed(title="다그다의 망치", description=" 공격력 +94\n체력 재생(%) +80%\n", color=0x9c4998)
        ...
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="휙득 경로 ", value="모닝스타 + 성자의 유산", inline=False)
        return embed

    if msg=="토르의망치":
        embed=discord.Embed(title="토르의망치", description=" 공격력 +80\n공격 속도(%) +30%\n", color=0x9c4998)
    ...
    if msg=="개밥바라기":
        embed=discord.Embed(title="개밥바라기", description=" 공격력 +90\n스킬 증폭 +22%", color=0xf9d537)
    ...
    if msg=="피스브링어":
        embed=discord.Embed(title="피스브링어", description=" 공격력 +120\n모든 피해 흡혈 10%\n방어력 관통 +12%\n", color=0xf9d537)
...
#####단검#####
    if msg=="식칼":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로 ", value="항구(6) 호텔(5) 절(6)\n사냥 멧돼지", inline=False)
        return embed
    ...
    if msg =="가위":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로 ", value="골목길(13) 병원(12) 학교(12)\n사냥 박쥐", inline=False)    
        return embed
    ...
    if msg=="만년필":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로", value="고급 주택가(12) 번화가(12) 학교(11)\n사냥 박쥐", inline=False)
        return embed
    ...
    if msg=="카른웬난":
        embed=discord.Embed(title="카른웬난", description=" 공격력 +33\n체력 재생 +60%\n이동 속도 +0.08\n쿨다운 감소 +8%\n\레벨 당 공격력 +2\n", color=0x9c4998)
    ...
    if msg=="초진동나이프"or msg=="초진동 나이프":
        embed=discord.Embed(title="초진동나이프", description=" 공격력 +50\n공격 속도(%) +50%\n이동 속도 +0.1\n", color=0x9c4998)
...
#####쌍검#####
    ...
    if msg=="자웅일대검":
        embed=discord.Embed(title="자웅일대검", description=" 공격력 +55\n공격 속도(%) +45%\n", color=0xf9d537)
    ...
    if msg =="디오스쿠로이":
        embed=discord.Embed(title="디오스쿠로이", description=" 공격력 +40\n공격 속도(%) +35%\n", color=0x9c4998)
    ...
    if msg=="로이거차르":
        embed=discord.Embed(title="로이거 차르", description=" 공격력 +35\n 레벨 당 스킬 증폭 +2%```저주-[고유 장착 효과]\n스킬 공격을 가하면 적을 초간 저주 상태로 만듭니다.\n저주 상태인 적은 이동 속도가 8%만큼 느려지고, 저주 상태에서 해제 될 때 85 + 스킬 증폭의 200% 에 해당하는 고정 피해를 입힙니다.\n한번 저주 상태가 되면 8초간 (기본 공격 피격 시 1초 감소) 다시 저주 상태가 되지 않습니다. (쿨다운 : 2초)```", color=0xf9d537)
    ...
    if msg=="아수라":
        embed=discord.Embed(title="아수라", description=" 공격력 +38\n쿨다운 감소 +12%\n모든피해 흡혈 +7%\n레벨 당 스킬 증폭 +1%\n", color=0x9c4998)
    ...
    if msg=="간장과막야":
        embed=discord.Embed(title="간장과막야", description=" 공격력+65\n 공격 속도 +18%\n (고유)기본 공격 사거리 +1\n", color=0xf9d537)
...
#####레이피어#####
    ...
    if msg=="볼틱레토":
        embed=discord.Embed(title="볼틱레토", description=" 공격력 +38\n공격 속도(%) +40%\n치명타 확률 +20%\n쿨다운 감소 +8%\n", color=0x9c4998)
    ...
    if msg=="유성검":
        embed=discord.Embed(title="유성검", description="공격력 +49\n치명타 피해량 +12%\n쿨다운 감소 +12%\n```차지드 스트라이크-[고유 장착 효과]\n매 3초마다 다음 공격이 100%의 치명타 확률 보너스를 획득합니다.```", color=0xf9d537)
    ...
    if msg=="주와이외즈":
        embed=discord.Embed(title="주와이외즈", description="공격력 +66\n공격 속도 +30%\n이동 속도 +0.1\n치명타 확률 10%\n치명타 피해량 +12%\n", color=0xf9d537)
    ...
    if msg=="에스프리":
        embed=discord.Embed(title="에스프리", description="공격력 +58\n스태미너 재생 +1\n치명타 확률 24%\n(고유) 기본 공격 사거리 +0.6\n", color=0x9c4998)
...
#####카메라#####
    ...
    if msg=="미러리스":
        embed=discord.Embed(title="미러리스", description=" 공격력 +38\n 시야 +1\n 레벨 당 스킬 증폭 +1.5%\n", color=0x9c4998)
    ...
    if msg=="카메라캐논":
        embed=discord.Embed(title="카메라 캐논", description=" 공격력 +45\n 최대 체력 +200\n 시야 +3.5\n (고유)기본 공격 사거리 +1", color=0x9c4998)
    ...
    if msg=="컴파운드사이트":
        embed=discord.Embed(title="컴파운드 사이트", description=" 공격력 +48\n 시야 +4\n 쿨다운 감소 +15%\n(고유) 최대 쿨다운 감소 +5%", color=0x9c4998)
    ...
    if msg=="울트라비전":
        embed=discord.Embed(title="울트라비전", description="공격력 +65\n스킬 증폭 +25%\n시야 +1.5\n```의념 (고유 장착 효과)\n스킬을 사용하면 의념을 충전합니다. 충전된 상태에서 다음 3초 안에 이루어지는 기본 공격이 (+스킬 증폭의 200%)의 고유 피해를 입힙니다.\n(쿨다운 3초)```", color=0xf9d537)
...
#####쌍절곤#####
    if msg=="쇠사슬":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로 ", value="모래사장(13) 골목길(14) 묘지(14)\n사냥 멧돼지", inline=False)
        return embed
    ...
    if msg=="대소반룡곤":
        embed=discord.Embed(title="대소반룡곤", description=" 공격력 +45\n 레벨 당 스킬 증폭 +1.5% ```스킬 공격 치유 방해-[고유 장착 효과]\n 스킬 공격에 피격된 대상의 치유 효과가 4초 동안 45% 감소합니다.```", color=0x9c4998)
    ...
    if msg=="초진동눈차크":
        embed=discord.Embed(title="초진동눈차크", description=" 공격력 +55\n 공격 속도(%) +50%\n", color=0x9c4998)
    ...
    if msg=="히드라":
        embed=discord.Embed(title="히드라", description=" 공격력 +100\n 모든 피해 흡혈(%) +25%\n쿨다운 감소 +10%", color=0xf9d537)
...
#####권총#####
    ...
    if msg=="마탄의사수":
        embed=discord.Embed(title="마탄의 사수", description="장탄 수: 3발\n 공격력 +36\n 공격 속도(%) +30%\n 이동 속도 +0.06\n 스킬 증폭 +20%\n ```최후의 한발-마탄-[고유 장착 효과]\n 마지막 탄환으로 가하는 기본 공격이 스킬 증폭 × 2 + 스킬 공격 추가 피해 × 2 + 적 최대 체력의 8% 에 해당하는 스킬 피해를 입히고, 입힌 피해의 66%만큼의 체력을 회복합니다.```", color=0xF9D537)
    ...
    if msg=="엘레강스":
        embed=discord.Embed(title="엘레강스", description="장탄 수: 8발\n 공격력 +48\n 레벨 당 공격력 +2\n 이동 속도 +0.08\n 시야 +1.0\n", color=0x9c4998)
    ...
    if msg=="일렉트론블라스터":
        embed=discord.Embed(title="일렉트론 블라스터", description="장탄 수: 12발\n 공격력 +51\n 공격 속도(%) +35%\n 이동 속도 +0.06\n 레벨 당 기본 공격 증폭 +1.2%\n", color=0x9c4998)
    ...
    if msg=="매그넘보아":
        embed=discord.Embed(title="매그넘-보아", description="장탄 수: 8발\n 공격력 +72\n 공격 속도(%) +25%\n 이동 속도 +0.06\n 생명력 흡수 +18%\n", color=0x9c4998)
    ...
    if msg=="글록48":
        embed=discord.Embed(title="글록 48", description="장탄 수: 10발\n 공격력 +65\n 공격 속도(%) +20%\n 이동 속도 +0.06\n 시야 +2.5\n (고유)기본 공격 사거리 +0.6\n", color=0x9c4998)
    ...
    if msg=="악켈테":
        embed=discord.Embed(title="악켈테", description="장탄 수: 12발\n 공격력 +83\n 공격 속도 +40%\n 이동 속도 +0.08\n 시야 +2\n 방어 관통 +12%\n", color=0xf9d537)
...
######방망이#####
    ...
    if msg=="몽둥이":
        embed=discord.Embed(title="몽둥이", description=" 공격력 +32\n", color=0x1e82cd)
    ...
    if msg=="마법봉":
        embed=discord.Embed(title="마법봉", description=" 공격력 +49\n 모든 피해 흡혈 +15%\n 시야 +1\n 스킬 증폭 +25%\n", color=0xf9d537)
    ...
    if msg=="구원의여신상":
        embed=discord.Embed(title="구원의 여신상", description=" 공격력 +54\n 레벨 당 공격력 +2\n 체력 재생 +35%\n 스테미너 재생(%) +80%\n 공격 속도(%) +15%\n 생명력 흡수 +12%\n", color=0x9c4998)
    ...
    if msg=="타구봉":
        embed=discord.Embed(title="타구봉", description="공격력 +69\n 공격 속도(%) +40%\n ```기본 공격 치유 방해-[고유 장착 효과]\n 기본 공격에 피격된 대상의 치유 효과가 4초 동안 45% 감소합니다.```", color=0x9c4998)
    ...
    if msg=="스파이의우산":
        embed=discord.Embed(title="스파이의 우산", description=" 공격력 +60\n 스테미너 재생 +0.8\n스킬 증폭 +15%\n 스킬 공격 치유 방해-[고유 장착 효과]\n 스킬 공격에 피격된 대상의 치유 효과가 4초 동안 45% 감소합니다.```", color=0x9c4998)
    ...
    if msg=="여의봉":
        embed=discord.Embed(title="여의봉", description="공격력 +115\n 공격 속도 +10%\n (고유)기본 공격 사거리 +0.8", color=0xf9d537)
    ...
    if msg=="팔괘장":
        embed=discord.Embed(title="팔괘장", description="공격력 +34\n레벨 당 스킬 증폭 +1%\n쿨다운 감소 +8%\n```저주 (고유 장착 효과)\n스킬 공격을 가하면 상대를 4초간 저주 상태에 빠트립니다.\n저주 상태인 적은 이동 속도가 6%만큼 느려지고, 저주 상태가 해제될 때 50 + 스킬 증폭의 1.35배의 피해를 입습니다.\n저주 상태가 되면 8초간 다시 저주 상태가 되지 않습니다.\n기본 공격 피격 시 해당 시간이 1초씩 감소합니다.\n쿨다운 2초```", color=0x9c4998)
...
######도끼#####
    ...
    if msg=="손도끼":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로", value="연못(6) 모래사장(5) 공장(6)\n사냥 들개", inline=False)
        return embed
    ...
    if msg=="곡괭이":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로", value="연못(14) 모래사장(13) 묘지(14) 숲(14)\n사냥 박쥐", inline=False)
        return embed
    ...
    if msg=="대부":
        embed=discord.Embed(title="대부", description=" 공격력 +88\n 이동 속도 -0.06", color=0x1e82cd)
    ...
    if msg=="빔엑스":
        embed=discord.Embed(title="빔 엑스", description=" 공격력 +82\n 레벨당  공격력 +2\n 시야 +3\n", color=0x9c4998)
    ...
    if msg=="반고부":
        embed=discord.Embed(title="반고부 ", description="공격력 +115\n공격 속도 +20%\n(고유) 방해 효과 저항 30%\n", color=0xf9d537)
...
######톤파######
    if msg=="대나무":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="연못(9) 절(9) 양궁장(8) 묘지(13) 숲(11)\n사냥 박쥐", inline=False)
        return embed
    ...
    if msg=="택티컬톤파":
        embed=discord.Embed(title="택티컬 톤파", description=" 공격력 +62\n모든 피해 흡혈 9%", color=0x9c4998)
    ...
    if msg=="마이쏙":
        embed=discord.Embed(title="마이쏙", description=" 공격력 +45\n 방어력 +18\n체력 재생(%) +70%\n```세컨드 윈드 - 공방일체 [고유 장착 효과] \n적 실험체에게 피해를 받으면, 2.5초간 (40 + 레벨당 5)의 보호막을 얻습니다.\n(쿨다운: 25초)```", color=0x9c4998)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/892289488863236177/892289544559419452/006._Mai_Sok_.png")
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="획득 경로", value="류큐톤파 + 거북이 등딱지", inline=False)
        return embed

    if msg=="플라즈마톤파":
        embed=discord.Embed(title="플라즈마 톤파", description=" 공격력 +48\n 방어력 +6\n 시야 +2\n", color=0x9c4998)
...
######저격총######
    if msg=="화승총":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="항구(4) 숲(4)", inline=False)
        return embed
...
######돌격소총######
    if msg=="페도로프자동소총":
        ...
        embed.add_field(name="등급 ", value="일반 ", inline=False)
        embed.add_field(name="휙득 경로", value="호텔(8) 고급 주택가(7) 공장(5)", inline=False)
        return embed
    ...
    if msg=="아그니":
        ...
        embed.add_field(name="등급 ", value="영", inline=False)
...
######활######
    ...
    if msg=="양궁":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="양궁장(6) 성당(5)", inline=False)
        return embed
    ...
    if msg=="국궁":
        embed=discord.Embed(title="국궁", description="공격력 +58\n레벨 당 기본 공격 증폭 +1%", color=0x1e82cd)
    ...
    if msg=="벽력궁":
        embed=discord.Embed(title="벽력궁", description=" 공격력 +35\n레벨 당 기본 공격 증폭 +0.7%", color=0x1e82cd)
    ...
    if msg=="편전":
        embed=discord.Embed(title="편전", description=" 공격력 +74\n레벨 당 기본 공격 증폭 +1.4%", color=0x9c4998)
    ...
    if msg=="골든래쇼보우":
        embed=discord.Embed(title="골든래쇼 보우", description=" 공격력 +56\n쿨다운 감소 +15%\n스킬 증폭 +22%\n\n", color=0x9c4998)
    ...
    if msg=="제베의활":
        embed=discord.Embed(title="제베의 활", description=" 공격력 +70\n공격 속도 +33%\n이동 속도 +0.06\n", color=0x9c4998)
    ...
    if msg=="아르테미스":
        embed=discord.Embed(title="아르테미스", description=" 공격력 +78\n최대 체력 +150\n시야 +2\n스킬 증폭 +25%\n", color=0xf9d537)
    ...
    if msg=="엘리멘탈보우":
        embed=discord.Embed(title="엘리멘탈 보우", description=" 공격력 +55\n 이동 속도 +0.06\n 스킬 증폭 +25%\n ```스킬 공격 치유 방해-[고유 장착 효과]\n스킬 공격에 피격된 대상의 치유 효과가 4초 동안 35% 감소합니다.```", color=0x9c4998)
    ...
    if msg=="페일노트":
        embed=discord.Embed(title="페일노트", description=" 공격력 +98\n레벨 당 공격속도 +2%\n모든 피해 흡혈 +15%\n", color=0xf9d537)
    ...
    if msg=="아르기로톡소스":
        embed=discord.Embed(title="아르기로톡소스", description=" 공격력 +91\n스킬 증폭 +20%\n방어 관통 10%\n", color=0xf9d537)
...
#####석궁#####
    if msg =="석궁":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="숲(8) 성당(7)", inline=False)
        return embed
    ...
    if msg =="저격궁":
        embed=discord.Embed(title="저격궁", description=" 공격력 +35\n시야 +1\n", color=0x1e82cd)
    ...
    if msg =="발리스타":
        embed=discord.Embed(title="발리스타", description=" 공격력 +63\n레벨 당 스킬 증폭 +2%\n", color=0x9c4998)
    ...
    if msg =="저격크로스보우":
        embed=discord.Embed(title="저격 크로스보우", description=" 공격력 +71\n시야 +2\n (고유)기본 공격 사거리 +0.75", color=0x9c4998)
...
#####아르카나######
    ...
    if msg=="절제":
        embed=discord.Embed(title="절제", description=" 공격력 +56\n 방어력 -25\n체력 재생 +75%\n스태미너 재생 +125%\n주는 회복 증가 +25%\n", color=0x9c4998)
    ...
    if msg=="더스타":
        embed=discord.Embed(title="더 스타", description=" 공격력 +59\n쿨다운 감소 +10%\n시야 +1\n스킬 증폭 +15%\n", color=0x9c4998)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/910522113385975848/910522545965514752/011._The_Star__.png")
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="획득 경로", value="소유의 펜타클 + 철사", inline=False)
        return embed

    if msg=="더문":
        embed=discord.Embed(title="더 문", description=" 공격력 +75\n스킬 증폭 +10%\n시야 +1.5\n ```굴절-[고유 장착 효과]\n 굴절의 망토를 두릅니다.\n굴절의 망토는 적이 나에게 가하는 다음 스킬 및 트랩의 피해와 효과를 한번 보호해줍니다.\n (쿨다운 25초)```", color=0xf9d537)
    ...
    if msg=="여제":
        embed=discord.Embed(title="여제", description="공격력 +55\n스킬 증폭 +20%\n쿨다운 감소 +15%\n```한파-(고유 장착 효과)\n스킬로 적에게 피해를 입히면 2초간 이동 속도를 20%, 공격 속도를 30% 만큼 느리게 만듭니다.\n(쿨다운 4초)```", color=0xf9d537)
...
#####기타#####
    ...
    if msg=="싱글픽업":
        embed=discord.Embed(title="싱글 픽업", description=" 공격력 +15\n", color=0x329632)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/894652734987448330/894652770337038417/002._Golden_Bridge__.png")
        embed.add_field(name="등급", value="고급", inline=False)
        embed.add_field(name="획득경로", value="보급형 기타 + 배터리", inline=False)
        return embed
    ...
    if msg=="노캐스터":
        embed=discord.Embed(title="노캐스터", description=" 공격력 +25\n 공격 속도 +20%\n 생명력 흡수 +10%\n", color=0x1e82cd)
    ...
    if msg=="슈퍼스트랫":
        embed=discord.Embed(title="슈퍼스트랫", description=" 공격력 +46\n ", color=0x1e82cd)
    ...
    if msg=="야생마":
        embed=discord.Embed(title="야생마", description=" 공격력 +22\n 공격 속도 +25%\n ", color=0x1e82cd)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/894652734987448330/894652819175510066/008._Superstrat__.png")
        embed.add_field(name="등급", value="희귀", inline=False)
    ...
    if msg=="보헤미안":
        embed=discord.Embed(title="보헤미안", description=" 공격력 +55\n최대 체력 +200\n치명타 확률 +22%\n치명타 피해량 +5%", color=0x9C4998)
    ...
    if msg=="천국의계단":
        embed=discord.Embed(title="천국의 계단", description=" 공격력 +56\n시야 +2\n쿨다운 감소 +5%\n(고유) 최대 쿨다운 감소 5%\n스킬 증폭 +18%\n", color=0x9C4998)
        ...
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="획득경로", value="험버커 픽업 + 십자가", inline=False)
        return embed

    if msg=="퍼플헤이즈":
        embed=discord.Embed(title="퍼플 헤이즈", description="공격력 +75\n스킬 증폭 +23%\n스태미너 재생 +1\n", color=0x9C4998)
    ...
    if msg=="새티스팩션":
        embed=discord.Embed(title="새티스팩션", description=" 공격력 +51\n공격 속도 +30%\n생명력 흡수 +22%\n", color=0x9C4998)
    ...
    if msg=="원더풀투나잇":
        embed=discord.Embed(title="원더풀 투나잇", description=" 공격력 +75\n공격 속도 +20%\n ```열정-[고유 효과]\n기본 공격이 적 실험체에게 명중하면, 적 실험체에게 현재 체력의 6%에 해당하는 고유 피해를 입히며 열정 버프를 1스택 획득합니다.\n 열정: 버프\n 공격 속도 8% 증가\n 지속 시간: 7초\n 최대 스택: 5스택\n최대 스택이 쌓인 경우 15의 공격력과 0.1의 이동 속도를 추가로 얻습니다.```", color=0xF9D537)
    ...
    if msg=="더월":
        embed=discord.Embed(title="더 월", description=" 공격력 +65\n공격 속도 +20%\n", color=0x9C4998)
    ...
    if msg=="틴스피릿":
        embed=discord.Embed(title="틴 스피릿", description=" 공격력 +47\n공격 속도 +40%\n(고유)기본 공격 사거리 +0.35", color=0x9C4998)
...
#####창#####
    if msg=="단창":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="연못(5) 숲(5) 사냥: 멧돼지", inline=False)
        return embed
    ...
    if msg=="애각창":
        embed=discord.Embed(title="애각창", description="공격력 +102\n공격 속도 12%\n이동 속도 +0.12", color=0xf9d537)
        ...
        embed.add_field(name="등급", value="전설", inline=False)
        embed.add_field(name="획득경로", value="죽창 + 미스릴", inline=False)
        return embed
    ...
    if msg=="트리아이나":
        embed=discord.Embed(title="트리아이나", description="공격력 +83\n스킬 증폭 +21%\n쿨다운 감소 +5%", color=0x9C4998)
    ...
    if msg=="청룡언월도":
        embed=discord.Embed(title="청룡언월도", description="공격력 +98\n최대 체력 +120\n레벨 당 최대 체력 +5\n이동 속도 -0.05\n", color=0x9C4998)
    ...
    if msg=="방천화극":
        embed=discord.Embed(title="방천화극", description="공격력 +79\n스킬 증폭 +16%\n```스킬 공격 치유 방해-[고유 장착 효과]\n스킬 공격에 피격된 대상의 치유 효과가 4초 동안 45% 감소합니다.```", color=0x9C4998)
...
#####양손검#####
    if msg=="녹슨검":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="항구(6) 양궁장(8) 성당(7)", inline=False)
        return embed
    ...
    if msg=="뚜언띠엔":
        embed=discord.Embed(title="뚜언 띠엔", description="공격력 +67\n방어력 +22\n쿨다운 감소 +8%\n", color=0x9C4998)
    ...
    if msg=="아론다이트":
        embed=discord.Embed(title="아론다이트", description="공격력 +53\n공격 속도(%) +25%\n레벨 당 공격력 +1\n", color=0x9C4998)
    ...
    if msg=="엑스칼리버":
        embed=discord.Embed(title="엑스칼리버", description="공격력 +55\n최대 체력 +180\n체력 재생(%) +75%\n공격 속도(%) +20%\n", color=0x9C4998)
    ...
    if msg=="호푸어드":
        embed=discord.Embed(title="호푸어드", description="공격력 +44\n최대 체력 +130\n치명타 확률 +23%\n치명타 피해량 +10%\n", color=0x9C4998)
    ...
    if msg=="빛의검":
        embed=discord.Embed(title="빛의 검", description="공격력 +67\n공격속도 +38%\n시야 +2\n```섬광-[고유 장착 효과]\n다음에 가하는 기본 공격이 80의 추가 고유 피해를 주고 2초 동안 이동속도를 30%만큼 감소시킵니다.\n(쿨다운 : 6초)```", color=0xf9d537)
...
#####글러브#####
    if msg=="너클":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="묘지(5) 숲(6)", inline=False)
        return embed
    ...
    if msg=="목장갑":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="호텔(9) 병원(8)", inline=False)
        return embed
    ...
    if msg=="회단장갑":
        embed=discord.Embed(title="회단 장갑", description="공격력 +25\n스킬 증폭 +12%\n", color=0x1e82cd)
    ...
    if msg=="단영촌천투":
        embed=discord.Embed(title="단영촌천투", description="공격력 +40\n방어력 +18\n스테미너 재생(%) +50%\n모든 피해 흡수 +15%\n", color=0x9C4998)
    ...
    if msg=="디바인피스트":
        embed=discord.Embed(title="디바인 피스트", description="공격력 +49\n기본 공격 증폭 +15%\n", color=0x9C4998)
    ...
    if msg=="블러드윙너클":
        embed=discord.Embed(title="블러드윙 너클", description="공격력 +46\n최대 체력 +180\n이동 속도 +0.06\n", color=0x9C4998)
    ...
    if msg=="빙화현옥수":
        embed=discord.Embed(title="빙화현옥수", description="공격력 +35\n스킬 증폭 +12%\n레벨 당 스킬 증폭 +1% ", color=0x9C4998)
    ...
    if msg=="여래수투":
        embed=discord.Embed(title="여래수투", description="공격력 +40\n쿨다운 감소 +15%\n스킬 증폭 +15%\n", color=0x9C4998)
    ...
    if msg=="프로스트팽":
        embed=discord.Embed(title="프로스트 팽", description="공격력 +43\n쿨다운 감소 +10%\n스킬 증폭 +25%\n```한파-[고유 장착 효과]\n스킬로 적에게 피해를 입히면 2초간 이동 속도를 20%, 공격 속도를 10% 만큼 느리게 만듭니다.\n(쿨다운: 4초)```", color=0xf9d537)
...
#####암기#####
    if msg=="면도칼":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="병원(8) 성당(7) 학교(8) 사냥: 박쥐", inline=False)
        return embed
    ...
    if msg=="트럼프카드":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="호텔(12) 번화가(14) \n사냥: 멧돼지", inline=False)
        return embed
    ...
    if msg=="분필":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="공장(7) 성당(5) 학교(8) 박쥐", inline=False)
        return embed
    ...
    if msg=="옥전결":
        embed=discord.Embed(title="옥전결", description="최대 충전 수: 20발(충전: 20초)\n공격력 +55\n스킬 증폭 +15%\n저주-[고유 장착 효과]\n스킬 공격에 적중된 적은 [[저주]] 효과를 얻고 이동 속도가 4초간 6% 감소됩니다.\n[저주] 효과는 4초가 지난 후 완성되어 30(+스킬 증폭의 100%)의 고정 피해를 입힙니다.\n한 번 [저주] 효과를 받은 적은 8초간 같은 효과를 받지 않습니다.\n(쿨다운: 2초)", color=0x9C4998)
...
#####투척#####
    ...
    if msg=="쇠구슬":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="양궁장(12) 숲(14) 공장(14)\n사냥 맷돼지", inline=False)
        return embed
    ...
    if msg=="야구공":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="공장(1) 고급 주택가(4)", inline=False)
        return embed
    ...
    if msg=="아스트라페":
        embed=discord.Embed(title="아스트라페", description="최대 충전 수: 36발(충전: 3초) 공격력 +54\n치명타 확률 +24%\n치명타 피해량 +6%\n(고유)기본 공격 사거리 +0.75", color=0x9C4998)
...
#####채찍#####
    if msg=="채찍":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="휙득 경로", value="공장(4) 학교(4)", inline=False)
        return embed
    ...
    if msg=="벽력편":
        embed=discord.Embed(title="벽력편", description="공격력 +35\n 공격 속도 +15%\n", color=0x1e82cd)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891865097411100683/891865149395312660/004._Wind_Whip__.png")
        embed.add_field(name="등급", value="희귀", inline=False)
        embed.add_field(name="휙득 경로", value="철편 + 배터리", inline=False)
        return embed
    ...
    if msg=="플라즈마웜":
        embed=discord.Embed(title="플라즈마 웜", description="공격력 +65\n 공격 속도 +40%\n 시야 +1.5\n", color=0x9c4998)
    ...
    if msg=="뇌룡편":
        embed=discord.Embed(title="뇌룡편", description="공격력 +53\n 공격 속도 +12%\n 스킬 증폭 + 12%\n 레벨 당 스킬 증폭 +1%\n", color=0x9c4998)
    ...
    if msg=="캐소드라쉬":
        embed=discord.Embed(title="캐소드 라쉬", description="공격력 +65\n쿨다운 감소 +10%\n```신속-플라즈마 - [고유 장착 효과\n4초 이내에 3회의 개별 피해를 가하면, 2초간 이동 속도가 캐릭터 레벨 × 1% 증가하고, 105의 보호막을 얻습니다.\n(쿨다운 12초)```", color=0x9c4998)
...
#####설치#####
    ...
    if msg=="감시카메라":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="항구(4) 고급 주택가(4) 번화가(7) 병원(5) 양궁장(4) 묘지(6) \n박쥐(100%) 멧돼지 들개", inline=False)
        return embed
    ...
    if msg=="올가미":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="항구(4), 연못(4), 모래사장(4), 양궁장(4), 숲(4), 멧돼지", inline=False)
        return embed
    ...
    if msg=="쥐덫":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="연못(7), 모래사장(9), 묘지(9), 멧돼지", inline=False)
        return embed
    ...
    if msg=="C4" or msg=="C-4":
        embed=discord.Embed(title="C-4", description="트랩 피해 +310\n트랩 발동: 1.5초 후 넓은 범위로 폭발합니다.\n최대 수량: 5", color=0x9c4998)
    ...
    if msg=="더블기요틴":
        embed=discord.Embed(title="더블 기요틴", description="트랩 피해 +270\n트랩 발동: 대상을 1초 간 속박합니다.\n최대 수량: 5", color=0x9c4998)
    ...
    if msg=="크레모어":
        embed=discord.Embed(title="크레모어", description="트랩 피해 +250\n트랩 발동: 좁은 범위로 폭발하며, 피격된 대상은 0.5초간 기절합니다.\n최대 수량: 5", color=0x9c4998)
    ...
    if msg=="미스릴실":
        embed=discord.Embed(title="미스릴 실", description="트랩 피해 +360\n최대 수량: 5", color=0x9c4998)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/910213917391872050/915271584158199848/027._Smart_Bomb__.png")
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="획득 경로", value="미스릴 + 피아노 선", inline=False)
        return embed
#####재료#####
    ...
    if msg=="유리병":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 항구(11) 번화가(12) 성당(9)\n사냥 멧돼지 ", inline=False)
        return embed
    ...
    if msg=="못":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 번화가(13) 양궁장(13) 공장(14)\n사냥 박쥐(4.4%)", inline=False)
        return embed
    ...
    if msg=="거북이등딱지":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 항구(14) 연못(13) 모래사장(13)\n사냥 박쥐(4.4%)", inline=False)
        return embed
    ...
    if msg=="고무":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 항구(9) 골목길(9) 양궁장(9)\n사냥 박쥐 ", inline=False)
        return embed
    ...
    if msg=="고철":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 항구(14) 호텔(13) 병원(13) 공장(14)\n사냥 들개(9.8%)", inline=False)
        return embed
    ...
    if msg=="라이터":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 항구(14) 골목길(13) 공장(14) 학교(13)\n사냥 들개(9.8%)", inline=False)
        return embed
    ...
    if msg=="레이저포인터":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 고급 주택가(9) 병원(9) 학교(11)\n사냥 들개 ", inline=False)
        return embed
    ...
    if msg=="마패":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 모래사장(9) 골목길(9) 절(9)\n사냥 멧돼지(3.3%)", inline=False)
        return embed
    ...
    if msg=="배터리":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 항구(14) 번화가(14) 공장(14)\n사냥 들개(9.8%)", inline=False)
        return embed
    ...
    if msg=="알코올":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 병원(14) 공장(11) 학교(8)\n사냥 멧돼지(3.3%)", inline=False)
        return embed
    ...
    if msg=="오일" or msg=="기름":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 고급 주택가(13) 번화가(9) 양궁장(11) 공장(9)\n사냥 박쥐 ", inline=False)
        return embed
    ...
    if msg=="옷감":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 호텔(14) 번화가(14) 절(13)\n사냥 멧돼지 ", inline=False)
        return embed
    ...
    if msg=="원석":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 연못(16) 모래사장(14) 절(14) 숲(13)\n사냥 들개(9.8%)", inline=False)
        return embed
    ...
    if msg=="접착제":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 골목길(9) 병원(12) 공장(13)\n사냥 박쥐 ", inline=False)
        return embed
    ...
    if msg=="종이":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 절(13) 양궁장(13) 성당(13)\n사냥 박쥐 ", inline=False)
        return embed
    ...
    if msg=="철광석":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 호텔(9) 묘지(9) 숲(9)\n사냥 멧돼지 ", inline=False)
        return embed
    ...
    if msg=="캔":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 모래사장(9) 번화가(8) 학교(8)\n사냥 멧돼지(3.3%)", inline=False)
        return embed
    ...
    if msg=="피아노선":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 모래사장(14) 고급 주택가(14) 호텔(14) 성당(13)\n사냥 멧돼지(3.3%) 알파(6.3%)", inline=False)
        return embed
    ...
    if msg=="생명의나무" or msg =="생나" :
        embed=discord.Embed(title="생명의 나무", description="최대 수량: 3", color=0x9C4998)
    ...
    if msg=="운석":
        embed=discord.Embed(title="운석", description="최대 수량: 3", color=0x9C4998)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322810771836988/915272012887384074/037._Meteorite_.png")
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="획득 경로", value="채집 떨어진 유성\t`(절,학교,연못,공장,골목길,고급주택가,성당 랜덤)`\n사냥 위클라인(14.3%) 재생성된 곰(3.6%) 재생성된 늑대(3.8%)", inline=False)
        return embed

    if msg=="문스톤":
        embed=discord.Embed(title="문스톤", description="최대 수량: 3", color=0x9C4998)
    ...
    if msg=="미스릴":
        embed=discord.Embed(title="미스릴", description="최대 수량: 3", color=0x9C4998)
    ...
    if msg=="이온전지":
        ...
        embed.add_field(name="등급", value="희귀", inline=False)
        embed.add_field(name="획득 경로", value="배터리 + 탄산수", inline=False)
        return embed
...
#####음식#####
    ...
    if msg=="감자":
        embed=discord.Embed(title="감자", description="체력 재생 +300", color=0xffffff)
    ...
    if msg=="대구":
        embed=discord.Embed(title="대구", description="체력 재생 +300", color=0xffffff)
    ...
    if msg=="레몬":
        embed=discord.Embed(title="레몬", description="체력 재생 +300", color=0xffffff)
    ...
    if msg=="마늘":
        embed=discord.Embed(title="마늘", description="체력 재생 +300", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/913318922772709377/915274214351699968/004._Garlic_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="골목길(6) 절(8) 묘지(9)", inline=False)
        return embed

    if msg=="붕어":
        embed=discord.Embed(title="붕어", description="체력 재생 +300", color=0xffffff)
    ...
    if msg=="빵":
        embed=discord.Embed(title=" 빵", description="체력 재생 +300", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/913318922772709377/915274214783725648/006._Bread_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="병원(7) 학교(6)", inline=False)
        return embed
    ...
    if msg=="생라면"or msg=="라면":
        embed=discord.Embed(title="생라면", description="체력 재생 +300", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/913318922772709377/915274215773573120/009._Ramen_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="항구(6) 절(5) 공장(7)", inline=False)
        return embed
    ...
    if msg=="약초":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="연못(7) 절(6) 숲(7)", inline=False)
        return embed

    if msg=="초콜릿":
        embed=discord.Embed(title=" 초콜릿", description="체력 재생 +300", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/913318922772709377/915274223520448522/011._Chocolate_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="고급 주택가(6) 번화가(4) 양궁장(5)", inline=False)
        return embed

    if msg=="꿀바른대구살":
        embed=discord.Embed(title="꿀 바른 대구살", description="체력 재생 +475", color=0x329632)
    ...
    if msg=="대구간통조림":
        embed=discord.Embed(title=" 대구 간 통조림", description="체력 재생 +500", color=0x329632)
    ...
    if msg=="마늘빵":
        embed=discord.Embed(title="마늘빵", description="체력 재생 +450", color=0x329632)
    ...
    if msg=="버터":
        embed=discord.Embed(title="버터", description="체력 재생 +475", color=0x329632)
    ...
    if msg=="붕어빵":
        embed=discord.Embed(title=" 붕어빵", description="체력 재생 +400", color=0x329632)
    ...
    if msg=="초코파이":
        embed=discord.Embed(title=" 초코파이", description="체력 재생 +475", color=0x329632)
    ...
    if msg=="난초":
        embed=discord.Embed(title="난초", description="체력 재생 +375", color=0x329632)
    ...
    if msg=="마늘베이컨말이":
        embed=discord.Embed(title="마늘 베이컨 말이", description="체력 재생 +500", color=0x329632)
    ...
    if msg=="번":
        embed=discord.Embed(title="번", description="체력 재생 +500", color=0x329632)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/913318922772709377/915274578870288434/020._Bun_.png")
        embed.add_field(name="등급", value="고급", inline=False)
        embed.add_field(name="획득 경로", value="커피 + 빵", inline=False)
        return embed

    if msg=="햄버거":
        embed=discord.Embed(title="햄버거", description="체력 재생 +550", color=0x329632)
    ...
    if msg=="달걀생선필레":
        embed=discord.Embed(title=" 달걀 생선 필레", description="체력 재생 +500", color=0x329632)
    ...
    if msg=="시트러스케이크":
        embed=discord.Embed(title=" 시트러스 케이크", description="체력 재생 +375", color=0x329632)
    ...
    if msg=="마늘꿀절임":
        embed=discord.Embed(title="마늘 꿀절임", description="체력 재생 +475", color=0x329632)
    ...
    if msg=="계란빵":
        embed=discord.Embed(title="계란빵", description="체력 재생 +450", color=0x329632)
    ...
    if msg=="초코아이스크림":
        embed=discord.Embed(title=" 초코 아이스크림", description="체력 재생 +450", color=0x329632)
    ...
    if msg=="감자튀김":
        embed=discord.Embed(title="감자튀김", description="체력 재생 +550", color=0x1e82cd)
    ...
    if msg=="구운감자":
        embed=discord.Embed(title="구운 감자", description="체력 재생 +525", color=0x1e82cd)
    ...
    if msg=="구운붕어":
        embed=discord.Embed(title="구운 붕어", description="체력 재생 +525", color=0x1e82cd)
    ...
    if msg=="성수":
        embed=discord.Embed(title="성수", description="체력 재생 +750\n방어력 +10", color=0x9c4998)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/913318922772709377/915274613095796746/031._Holy_Water_.png")
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="획득 경로", value="미스릴 + 물\n 오메가 드랍", inline=False)
        return embed

    if msg=="메로구이":
        embed=discord.Embed(title="메로구이", description="체력 재생 +500", color=0x1e82cd)
    ...
    if msg=="뜨거운라면":
        embed=discord.Embed(title="뜨거운 라면", description="체력 재생 +500", color=0x1e82cd)
    ...
    if msg=="모카빵":
        embed=discord.Embed(title=" 모카빵", description="체력 재생 +550", color=0x1e82cd)
    ...
    if msg=="스크램블에그":
        embed=discord.Embed(title="스크램블 에그", description="체력 재생 +575", color=0x1e82cd)
    ...
    if msg=="초코칩쿠키":
        embed=discord.Embed(title="초코칩 쿠키", description="체력 재생 +622", color=0x1e82cd)
    ...
    if msg=="초코파이상자":
        embed=discord.Embed(title="초코파이 상자", description="체력 재생 +622", color=0x1e82cd)
    ...
    if msg=="탕약":
        embed=discord.Embed(title="탕약", description="체력 재생 +525", color=0x1e82cd)
    ...
    if msg=="허니버터":
        embed=discord.Embed(title="허니버터", description="체력 재생 +622", color=0x1e82cd)
    ...
    if msg=="힐링포션":
        embed=discord.Embed(title="힐링 포션", description="체력 재생 +550", color=0x1e82cd)
    ...
    if msg=="삶은달걀":
        embed=discord.Embed(title="삶은 달걀", description="체력 재생 +525", color=0x1e82cd)
    ...
    if msg=="술빵":
        embed=discord.Embed(title=" 술빵", description="체력 재생 +525", color=0x1e82cd)
    ...
    if msg=="스테이크":
        embed=discord.Embed(title="스테이크", description="체력 재생 +500", color=0x1e82cd)
    ...
    if msg=="구급상자":
        embed=discord.Embed(title="구급상자", description="체력 재생 +1000", color=0x9C4998)
    ...
    if msg=="버터감자구이":
        embed=discord.Embed(title="버터 감자구이", description="체력 재생 +622", color=0x1e82cd)
    ...
    if msg=="생선까스":
        embed=discord.Embed(title=" 생선까스", description="체력 재생 +550", color=0x1e82cd)
    ...
    if msg=="냉면":
        embed=discord.Embed(title="냉면", description="체력 재생 +525", color=0x1e82cd)
    ...
    if msg=="생일케이크":
        embed=discord.Embed(title="생일 케이크", description="체력 재생 +550", color=0x1e82cd)
    ...
    if msg=="마늘라면":
        embed=discord.Embed(title="마늘라면", description="체력 재생 +550", color=0x1e82cd)
    ...
    if msg=="일레븐세트":
        embed=discord.Embed(title="일레븐 세트", description="체력 재생 +750\n\n`일레븐 제작가능`", color=0x9c4998)
...
#####음료#####
    ...
    if msg=="꿀":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="골목길(8) 번화가(8) 숲(9)", inline=False)
        return embed
    ...
    if msg=="얼음":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="호텔(9) 병원(9) 묘지(9)", inline=False)
        return embed
    ...
    if msg=="위스키":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="고급 주택가(9) 호텔(5) 성당(7)", inline=False)
        return embed
    ...
    if msg=="커피콩":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="항구(7) 고급 주택가(4) 묘지(7)", inline=False)
        return embed
    ...
    if msg=="탄산수":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="모래사장(9) 고급 주택가(9) 호텔(9)", inline=False)
        return embed
    ...
    if msg=="우유":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="번화가(8) 병원(5) 성당(6) 학교(4)", inline=False)
        return embed
    ...
    if msg=="셀레네의눈물":
        ...
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="획득 경로", value="문스톤 + 물\n오메가 드랍", inline=False)
        return embed
...
#####머리#####
    if msg=="머리띠":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="번화가(13) 절(11) 묘지(11)\n사냥 박쥐 ", inline=False)
        return embed
    ...
    if msg=="모자":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="연못(11) 양궁장(11) 학교(12)\n사냥 박쥐 ", inline=False)
        return embed
    ...
    if msg=="자전거헬멧":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="모래사장(11) 성당(12) 학교(11) 연못(9)\n사냥 멧돼지(3.3%)", inline=False)
        return embed
    ...
    if msg=="미스릴투구" or msg=="미뚝":
        embed=discord.Embed(title="미스릴 투구", description="방어력 +33\n공격 속도 +30%\n이동 속도 +0.1\n쿨다운 감소 +15%\n", color=0xF9D537)
    ...
    if msg=="수정티아라":
        embed=discord.Embed(title="수정 티아라", description="방어력 +18\n최대 스태미너 +400\n치명타 확률 +20%\n치명타 피해량 +5%", color=0x9c4998)
    ...
    if msg=="다이아뎀":
        embed=discord.Embed(title="다이아뎀", description="공격력 +18\n방어력 +15\n최대 스태미너 +270\n쿨다운 감소 +12%\n", color=0x9c4998)
    ...
    if msg=="변검":
        embed=discord.Embed(title="변검", description="공격력 +22\n방어력 +20\n최대 스태미너 +200\n이동 속도 +0.1\n모든 피해 흡수 +20%\n", color=0xf9d537)
...
#####옷#####
    if msg=="바람막이":
        embed=discord.Embed(title="바람막이", description="방어력 +3\n공격력 +4", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/916320335131987998/920184357929512960/001._Windbreaker_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 고급 주택가(11) 호텔(11) 학교(12)\n사냥 들개", inline=False)
        return embed
    ...
    if msg=="승복":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 절(13) 양궁장(12)\n사냥 멧돼지", inline=False)
        return embed
    ...
    if msg=="전신수영복":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 항구(11) 모래사장(11) 골목길(11)\n사냥 들개", inline=False)
        return embed
    ...
    if msg=="천갑옷":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="지역 절(12) 양궁장(11) 묘지(11) 숲(9)\n사냥 들개", inline=False)
        return embed
    ...
    if msg=="가죽자켓":
        embed=discord.Embed(title="가죽 자켓", description="방어력 +7\n공격력 +8", color=0x329632)
    ...
    if msg=="군복":
        embed=discord.Embed(title="군복", description="공격력 +4\n방어력 +8\n최대 체력 +30\n", color=0x329632)
    ...
    if msg=="사제복":
        embed=discord.Embed(title="사제복", description="공격력 +8\n최대 체력 +80\n", color=0x329632)
    ...
    if msg=="라이더자켓":
        embed=discord.Embed(title="라이더 자켓", description="공격력 +15\n방어력 +10\n", color=0x1e82cd)
    ...
    if msg=="정장":
        embed=discord.Embed(title="정장", description="공격력 +10\n생명력 흡수 +15%\n", color=0x1e82cd)
    ...
    if msg=="고위사제복":
        embed=discord.Embed(title="고위 사제복", description="공격력 +12\n방어력 +10\n최대 체력 +140\n체력 재생 +45%\n", color=0x1e82cd)
    ...
    if msg=="방탄조끼":
        embed=discord.Embed(title="방탄조끼", description="방어력 +22\n최대 체력 +70\n", color=0x1e82cd)
    ...
    if msg=="용의도복":
        embed=discord.Embed(title="용의 도복", description="공격력 +15\n방어력 +15\n스태미너 재생 +100%\n쿨다운 감소 +10%\n(고유) 기본 공격 사거리 +0.5\n", color=0x9c4998)
    ...
    if msg=="집사복":
        embed=discord.Embed(title="집사복", description="공격력 +27\n생명력 흡수 +18%\n(고유) 이동 속도 +0.08", color=0x9c4998)
    ...
    if msg=="배틀슈트":
        embed=discord.Embed(title="배틀 슈트", description="방어력 +33\n최대 체력 +70\n치명타 피해 감소 +8%\n스킬 피해 감소 +8%\n", color=0x9c4998)
    ...
    if msg=="EOD슈트":
        embed=discord.Embed(title="EOD 슈트", description="방어력 +33\n최대 체력 +115\n체력 재생 +60%\n쿨다운 감소 +10%\n", color=0x9c4998)
    ...
    if msg=="턱시도":
        embed=discord.Embed(title="턱시도", description="방어력 +12\n모든 피해 흡혈 +12%", color=0x9c4998)
    ...
    if msg=="창파오":
        embed=discord.Embed(title="창파오", description="공격력 +12\n방어력 +10\n스태미너 재생 +2\n공격 속도 +37%\n", color=0x9c4998)
    ...
    if msg=="퀸오브하트"  or msg=="퀸오하":
        embed=discord.Embed(title="퀸 오브 하트", description="방어력 +35\n체력 재생 +100%\n쿨다운 감소 +30%\n(고유) 최대 쿨다운 감소 +10%\n", color=0xf9d537)
    ...
    if msg=="아오자이":
        embed=discord.Embed(title="아오자이", description="공격력 +50\n방어력 +65\n스태미너 재생 +100%\n\n`마이 제작 가능`", color=0xf9d537)
...
#####팔#####
    if msg=="손목시계":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="고급 주택가(9) 호텔(11) 번화가(9)\n사냥 들개 ", inline=False)
        return embed

    if msg=="붕대":
        embed=discord.Embed(title="붕대", description="체력 재생 +20%", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322279160602634/892443819780485230/002._Bandage_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="항구(14) 골목길(14) 병원(13) 학교(13)\n사냥 박쥐 (4.4%) ", inline=False)
        return embed
    ...
    if msg=="팔찌":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득 경로", value="연못(12) 고급 주택가(11) 골목길(11)\n 사냥  들개 ", inline=False)
        return embed
    ...
    if msg=="분대장완장":
        embed=discord.Embed(title="분대장 완장", description="체력 재생 +35%\n치명타 피해량 +15%", color=0x329632)
    ...
    if msg=="강철방패":
        embed=discord.Embed(title="강철 방패", description="공격력 +15\n방어력 +15", color=0x1e82cd)
    ...
    if msg=="드라우프니르":
        embed=discord.Embed(title="드라우프니르", description="방어력 +15\n최대 스태미너 +240\n체력 재생 +40%\n스킬 증폭 +19%", color=0x9c4998)
    ...
    if msg=="미스릴방패" or msg=="미방":
        embed=discord.Embed(title="미스릴 방패", description="공격력 +25\n방어력 +30\n공격 속도 +25%\n이동 속도 +0.1\n", color=0xF9D537)
    ...
    if msg=="바이탈센서":
        ...
        embed.add_field(name="등급", value="희귀", inline=False)
        embed.add_field(name="획득 경로", value="손목 시계 + 전자 부품", inline=False)
        return embed

    if msg=="기사의신조":
        embed=discord.Embed(title="기사의 신조", description="공격력 +25\n방어력 +22\n체력 재생 +45%\n치명타 피해량 +15%\n", color=0x9c4998)
    ...
    if msg=="플라즈마아크":
        embed=discord.Embed(title="플라즈마 아크", description="공격력 +15\n방어력 +15\n공격 속도 +24%\n", color=0x9c4998)
    ...
    if msg=="텔루리안타임피스" or msg == "텔루리":
        embed=discord.Embed(title="텔루리안 타임피스", description="방어력 +15\n쿨다운 감소 +15%\n공격 속도 +40%\n 굴절-[고유 장착 효과]\n굴절의 망토를 두릅니다. 굴절의 망토는 적이 나에게 가하는 다음 스킬 및 트랩의 피해와 효과를 한번 보호해 준 뒤 사라지고, 25초 후 재생성 됩니다.", color=0xf9d537)
    ...
    if msg=="오토암즈" or msg == "오암":
        embed=discord.Embed(title="오토-암즈", description="공격력 +40\n방어력 +35\n체력 재생 +50%\n치명타 피해 감소 +8%\n", color=0xf9d537)
...
#####다리#####
    if msg=="슬리퍼":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 항구(11) 번화가(12) 학교(12)\n사냥 박쥐", inline=False)
        return embed
    ...
    if msg=="타이즈":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 번화가(11) 병원(11) 숲(11)\n사냥 멧돼지(3.3%)", inline=False)
        return embed

    if msg=="무릎보호대":
        embed=discord.Embed(title="무릎 보호대", description="방어력 +5\n이동 속도 +0.13", color=0x329632)
    ...
    if msg=="부츠":
        embed=discord.Embed(title="부츠", description="체력 재생 +15%\n공격 속도 +2%\n이동 속도 +0.17\n", color=0x329632)
    ...
    if msg=="등산화":
        embed=discord.Embed(title="등산화", description="이동 속도 +0.29", color=0x1e92cd)
    ...
    if msg=="강철무릎보호대":
        embed=discord.Embed(title="강철 무릎 보호대", description="방어력 +10\n이동 속도 +0.21", color=0x1e92cd)
    ...
    if msg=="전투화":
        embed=discord.Embed(title="전투화", description="체력 재생 +15%\n공격 속도 +7%\n이동 속도 +0.21\n", color=0x1e92cd)
    ...
    if msg=="경량화부츠":
        embed=discord.Embed(title="경량화 부츠", description="체력 재생 +25%\n공격 속도 +30%\n이동 속도 +0.32\n", color=0x9c4998)
    ...
    if msg=="클링온부츠":
        embed=discord.Embed(title="클링온 부츠", description="체력 재생 +20%\n공격 속도 +15%\n이동 속도 +0.29\n```기본 공격 치유 방해-[고유 장착 효과]\n기본 공격에 피격된 대상의 치유 효과가 4초 동안 감소합니다.\n(근거리) 치유 효과가 45% 감소합니다.\n(원거리) 치유 효과가 35% 감소합니다.```", color=0x9c4998)
    ...
    if msg=="타키온브레이스":
        embed=discord.Embed(title="타키온 브레이스", description="방어력 +10\n이동 속도 +0.3\n쿨다운 감소 +8%\n", color=0x9c4998)
    ...
    if msg=="SCV":
        embed=discord.Embed(title="SCV", description="모든 피해 흡혈 10%\n이동 속도 +0.33", color=0x9c4998)
    ...
    if msg=="탭루트":
        embed=discord.Embed(title="탭루트", description="쿨다운 감소 +22%\n(고유) 최대 쿨다운 감소 +10%\n이동 속도 +0.4\n", color=0xf9d537)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322212408238131/892443422143696936/022._Taproot_.png")
        embed.add_field(name="등급", value="전설", inline=False)
        embed.add_field(name="획득경로", value="나막신 + VF 혈액 샘플", inline=False)
        return embed

    if msg=="EOD부츠":
        embed=discord.Embed(title="EOD 부츠", description="방어력 +15\n체력 재생 +40%\n스태미너 재생 +0.5\n이동 속도 +0.32\n트랩 피해 감소 +10%\n", color=0x9C4998)
    ...
    if msg=="헤르메스의부츠" or msg=="헤르메스":
        embed=discord.Embed(title="헤르메스의 부츠", description="방어력 +27\n이동 속도 +0.42\n(고유) 방해 효과 저항 +25%\n", color=0xf9d537)
    ...
    if msg=="분홍신":
        embed=discord.Embed(title="분홍신", description="공격력 +20\n스태미너 재생 +1\n이동 속도 +0.42\n모든 피해 흡혈 +15%\n", color=0xf9d537)
...
#####장식#####
    ...
    if msg=="꽃":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="채집: 연못, 고급 주택가, 묘지, 숲\n사냥 멧돼지", inline=False)
        return embed
    ...
    if msg=="리본":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 연못(11) 고급 주택가(11) 학교(9)\n사냥 들개", inline=False)
        return embed

    if msg=="부채":
        embed=discord.Embed(title="부채", description="스킬 증폭 +5%", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322263075450882/892443503374790697/004._Fan_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 번화가(13) 숲(13) 성당(11)\n사냥 들개", inline=False)
        return embed

    if msg=="불경":
        embed=discord.Embed(title="불경", description="스킬 증폭 +5%", color=0xffffff)
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 절(14)\n사냥 박쥐", inline=False)
        return embed
    ...
    if msg=="상자":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 항구(9) 연못(9) 성당(12)\n사냥 박쥐", inline=False)
        return embed

    if msg=="성배":
        embed=discord.Embed(title="성배", description="체력 재생 +30%", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322263075450882/892443521829699604/007._Holy_Grail_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 성당(14)\n사냥 박쥐", inline=False)
        return embed

    if msg=="십자가":
        embed=discord.Embed(title="십자가", description="공격력 +3", color=0xffffff)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322263075450882/892443526711902248/008._Cross_.png")
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 골목길(8) 성당(14)\n사냥 들개", inline=False)
        return embed
    ...
    if msg=="쌍안경":
        ...
        embed.add_field(name="등급", value="일반", inline=False)
        embed.add_field(name="획득경로", value="지역 모래사장(6) 골목길(7) 호텔(6) 공장(9)\n사냥 박쥐(4.4%)", inline=False)
        return embed

    if msg=="성자의유산":
        embed=discord.Embed(title="성자의 유산", description="공격력 +8\n체력 재생(%) +50%\n", color=0x329632)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322263075450882/892443526711902248/008._Cross_.png")
        embed.add_field(name="등급", value="고급", inline=False)
        embed.add_field(name="획득경로", value="십자가 + 성배", inline=False)
        return embed
    ...
    if msg=="화살통":
        embed=discord.Embed(title="화살통", description="공격 속도 +12%", color=0x329632)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322263075450882/892443587978068050/016._Quiver_.png")
        embed.add_field(name="등급", value="고급", inline=False)
        embed.add_field(name="획득경로", value="대나무 + 깃털", inline=False)
        return embed
    ...
    if msg=="군선":
        embed=discord.Embed(title="군선", description="스킬 증폭 +8%\n```스킬 공격 치유 방해-[고유 장착 효과]\n스킬 공격 시 피격된 대상의 치유 효과가 감소합니다.\n(근거리) 치유 효과가 45% 감소합니다.\n(원거리) 치유 효과가 35% 감소합니다.```", color=0x329632)
    ...
    if msg=="백우선":
        embed=discord.Embed(title="백우선", description="스킬 증폭 +11%\n(고유) 이동 속도 +0.04\n```스킬 공격 치유 방해-[고유 장착 효과]\n스킬 공격 시 피격된 대상의 치유 효과가 감소합니다.\n(근거리) 치유 효과가 45% 감소합니다.\n(원거리) 치유 효과가 35% 감소합니다.```", color=0x1e82cd)
    ...
    if msg=="능동위장":
        embed=discord.Embed(title="능동 위장", description="방어력 +12\n최대 체력 +200\n", color=0x1e82cd)
    ...
    if msg=="슈뢰딩거의상자":
        embed=discord.Embed(title="슈뢰딩거의 상자", description="최대 체력 +190\n```스킬 공격 치유 방해-[고유 장착 효과]\n스킬 공격 시 피격된 대상의 치유 효과가 감소합니다.\n(근거리) 치유 효과가 45% 감소합니다.\n(원거리) 치유 효과가 35% 감소합니다.```", color=0x1e82cd)
    ...
    if msg=="달빛펜던트" or msg=="달펜":
        embed=discord.Embed(title="달빛 펜던트", description="공격력 +26\n시야 +1\n모든 피해 흡혈 +15%\n", color=0xF9D537)
    ...
    if msg=="미스릴퀴버" or msg=="미퀴":
        embed=discord.Embed(title="미스릴 퀴버", description="방어력 +16\n공격 속도 +33%\n이동 속도 +0.1\n(고유) 기본 공격 사거리 +0.5\n", color=0xF9D537)
    ...
    if msg=="에메랄드타블렛" or msg=="에타":
        embed=discord.Embed(title="에메랄드 타블렛", description="공격력 +19\n치명타 피해량 +12%\n쿨다운 감소 +15%\n치명타 확률 15%", color=0xf9d537)
    ...
    if msg=="파초선":
        embed=discord.Embed(title="파초선", description="쿨다운 감소 +12%\n```가벼운 발걸음-[고유 장착 효과]\n 0.2m 이동할기본 때마다 [가벼운 발걸음]을 최대 100회까지 중첩해서 획득합니다. 중첩에 따라 이동 속도가 최대 0.15까지 증가합니다.  공격 피해를 입힐 경우 중첩을 모두 소모하여 최대 150의 고유 피해를 입힙니다.\n(근거리) 최대 중첩 상태에서 피격된 대상의 이동속도를 2초 동안 30% 감소 시킵니다.``` ```스킬 공격 치유 방해-[고유 장착 효과]\n스킬 공격 시 피격된 대상의 치유 효과가 감소합니다.\n(근거리) 치유 효과가 60% 감소합니다.\n(원거리) 치유 효과가 50% 감소합니다.```", color=0xf9d537)
    ...
    if msg=="호루스의눈":
        embed=discord.Embed(title="호루스의 눈", description="레벨 당 스킬 증폭 +0.1%\n시야 +1.5\n```의념 (고유 장착 효과)\n스킬 증폭의 2.5배(근거리)/1.5배(원거리)의 고유 피해를 입힙니다.\n(쿨다운: 2초)```", color=0xF9D537)
    ...
    if msg=="아티팩트":
        embed=discord.Embed(title="아티팩트", description="공격력 +18\n방어력 +8\n```정지 - [고유 장착 스킬]\n사용 시 2.5초간 경직 상태에 빠집니다.\n(쿨다운: 55초)```", color=0xf9d537)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/891322263075450882/938770169386389545/Artifact_.png")
        embed.add_field(name="등급", value="영웅", inline=False)
        embed.add_field(name="획득경로", value="철광석 + 생명의 나무", inline=False)
        return embed

    else:
        embed=discord.Embed(title="오류!", description="이름을 다시 한번 확인해주세요!", color=0xffbb00)
        return embed
